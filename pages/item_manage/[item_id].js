...
async function updateItemSubmitHandle(e) {
  ...
  <div className="mb-3">
    ...
    <input onChange={e => setNewName(e.target.value)} type="text" className="form-control" />
      </div>
  <div className="mb-3">
    <label className="form-label">Website&apos;s name</label>
    <input onChange={e => setNewWebsite(e.target.value)} type="text" className="form-control" />
      </div>
  <div className="mb-3">
    <label className="form-label">Item&apos;s URI/Link </label>
    <input onChange={e => setNewUri(e.target.value)} type="text" className="form-control" />
      </div>
  <div className="mb-3">
    <label className="form-label">Item&apos;s wanted price </label>
    <input onChange={e => setNewPrice(e.target.value)} type="number" className="form-control" />
      </div>
  <button type="submit" className="btn btn-primary">Submit</button>
    </form>
    
 <button onClick={deleteItemFunc} className="btn mt-4 mb-2 btn-danger btn-sm d-block w-100">Delete this item permanently</button>
