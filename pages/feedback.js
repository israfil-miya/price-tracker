...
export default function Feedback() {
  ...
  const image = session.user.image ? session.user.image : "/static/images/me.jpg" ;
  ...
  return (
    ...
    <input type="text" value={session.user?.name} className="text-muted form-name form-control" disabled/>
    <div id="emailHelp" className="form-text">Automatically filled by Session</div>
  </div>
    <div className="text-center"><p className="px-3 d-inline-block text-center py-2 mt-2 bg-warning rounded border border-1">
    Feedback Form
    </p></div>
  ...
  <div className="mb-3">
    ...
    <textarea onChange={e => setMessage(e.target.value)} required rows="5" cols="5" className="form-control"></textarea>
  </div>
  <button type="submit" className="btn btn-primary">Submit</button>
</form>

<div className="text-center"><p className="px-3 d-inline-block text-center py-2 mt-4 bg-warning rounded border border-1">
    Ask Question
    </p></div>
    ...
    <textarea onChange={e => setQuestion(e.target.value)} required rows="2" cols="5" className="form-control"></textarea>
  </div>
  <button type="submit" className="btn btn-primary">Submit</button>
</form>
